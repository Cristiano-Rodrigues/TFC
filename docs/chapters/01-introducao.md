...
Na era da economia digital, o volume de dados gerados pelas organizações cresce a um ritmo acelerado. Segundo o *International Data Corporation* (IDC), projectou-se que o volume global de dados criados, capturados, copiados e consumidos cresceria de 33 *zettabytes* em 2018 para 175 *zettabytes* até 2025 [@reinselDigitizationWorldEdge2018]. No segmento especificamente organizacional, a *Enterprise DataSphere* — o subconjunto de dados gerados e geridos pelas empresas — regista uma taxa de crescimento anual composta superior à do segmento de consumo, evidenciando que as organizações se têm consolidado como os principais motores do crescimento informacional contemporâneo [@reinselDigitizationWorldEdge2018]. A informação deixou de ser apenas um subproduto das operações comerciais e administrativas para se consolidar como um dos principais activos estratégicos das corporações, capaz de sustentar a tomada de decisão, promover a inovação e reforçar vantagens competitivas num mercado globalizado. Neste contexto, a capacidade de extrair valor e conhecimento accionável a partir de volumes crescentes de dados assume uma relevância cada vez maior para as organizações.
...
O **Capítulo 4 (Resultados da Pesquisa)** é dedicado à vertente empírica e prática do projecto. Nele, apresenta-se a metodologia de desenvolvimento do protótipo, a modelação UML (casos de uso, classes, base de dados), a arquitectura lógica da solução e as evidências de funcionamento através de interfaces, documentação de código e resultados de testes.
