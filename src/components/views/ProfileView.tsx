      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-2xs">
        ...
        <div className="p-6 relative">
          ...
          <div className="pt-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <button
              onClick={signOut}
              className="bg-white hover:bg-slate-50 text-slate-700 hover:text-red-600 border border-slate-200 text-xs font-semibold px-4 py-2 rounded-md shadow-2xs cursor-pointer transition-colors shrink-0"
            >
              Terminar Sessão
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="border border-slate-200 p-4 rounded-xl bg-[#f3f3f5] space-y-2">
              ...
              <p className="text-[10px] text-slate-600 leading-[14px]">
